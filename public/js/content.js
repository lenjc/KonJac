...
async function konjacNotification(msg, duration = 3000) {
    if ($('#konjacNotification').length) {
        ...
        $('body').prepend(`<div id='konjacNotification' style='position: fixed;top: 20px;left: 50%;transform: translateX(-50%);z-index: 1000000;padding:5px 10px;background-color: #fff;box-shadow: 0px 0px 5px rgba(0, 0, 0, 0.1);border-radius: 5px;font-family: 微软雅黑, Microsoft YaHei, sans-serif;font-weight: normal;font-size: medium;user-select: none;'><div>KonJac : </div><div>${msg}</div></div>`)
    }
    if (duration) {
